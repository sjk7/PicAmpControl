...
- ADC series-resistor and clamp requirements are consolidated in [adc-input-protection-guidance.md](adc-input-protection-guidance.md).
- Physical pins 2, 3, 4, 5, 7, 22, 23, and 24 use a nominal 1 kOhm series resistor and two single Schottky rail clamps; see the ADC protection guidance for signal names, diode orientation, and high-energy transient exceptions.
