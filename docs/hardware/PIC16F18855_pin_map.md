...
- Each ADC input uses a nominal 1 kOhm series resistor and two single Schottky rail clamps; see the ADC protection guidance for diode orientation and high-energy transient exceptions.
