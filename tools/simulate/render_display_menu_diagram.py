...
def main():
    ...
    box(ax, 0.7, 3.35, 2.7, 0.85, "Any protection trip?", "#ffd0d0")
    box(ax, 4.3, 3.35, 2.8, 0.85, "TRIP display priority\nshow FAULT reason", "#ffd0d0")
    box(ax, 8.0, 3.35, 2.8, 0.85, "TX_VCC HIGH immediately\nRELAYS + BIAS HIGH after 5 ms", "#ffd0d0")
    ax.text(10.95, 5.25, "protection monitored during TX", ha="right", fontsize=8, color="#b71c1c")
    arrow(ax, (11.0, 5.65), (10.55, 4.2))
    arrow(ax, (3.4, 3.78), (4.3, 3.78), "yes")
    arrow(ax, (7.1, 3.78), (8.0, 3.78))
    ...
    arrow(ax, (5.7, 3.35), (2.05, 2.5), "temperature only")
